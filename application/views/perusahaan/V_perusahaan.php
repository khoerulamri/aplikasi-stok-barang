                ...
                <div class="col-lg-6">
                    ...
                    { 
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Masukan kode perusahaan" name="kode_perusahaan"
                            <?php if($status=='ubah'){echo "value=\"".$kode_perusahaan."\"" ;} ?>>
                        </div>
                        <div class="form-group">
                            <label>Nama Perusahaan</label>
                            <input class="form-control" placeholder="Masukan nama perusahaan" name="nama_perusahaan"
