      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if(($menu_active=='produksi')||($menu_active=='gudang')||($menu_active=='gudang_produksi')||($menu_active=='penjualan')||($menu_active=='gudangpenjualan')||($menu_active=='produksigudang'))
          ...
          <ul class="treeview-menu">
            <?php
            if ('administrator'==$kode_hak_akses || 'produksi'==$kode_hak_akses || 'produksigudang'==$kode_hak_akses|| 'produksigudangpenjualan'==$kode_hak_akses)
            { ?>
            ...
            <?php } 
            if ('administrator'==$kode_hak_akses || 'gudang'==$kode_hak_akses || 'gudangpenjualan'==$kode_hak_akses || 'produksigudang'==$kode_hak_akses || 'produksigudangpenjualan'==$kode_hak_akses)
            { ?>
            ...
            <?php } 
            if ('administrator'==$kode_hak_akses || 'penjualan'==$kode_hak_akses || 'gudangpenjualan'==$kode_hak_akses || 'produksigudangpenjualan'==$kode_hak_akses)
            { ?>
        ...
        <?php
            if ('administrator'==$kode_hak_akses || 'gudang'==$kode_hak_akses || 'penjualan'==$kode_hak_akses || 'gudangpenjualan'==$kode_hak_akses || 'produksigudang'==$kode_hak_akses || 'produksigudangpenjualan'==$kode_hak_akses)
            { ?>
